...
function SvgWrap({ children, className = "", viewBox = "0 0 24 24" }: SvgWrapProps) {
  return (
    <svg
      aria-hidden="true"
      className={className}
...
export function MobileIcon({ className = "h-7 w-7" }: IconProps) {
  return (
...
export function FingerprintIcon({ className = "h-7 w-7" }: IconProps) {
  return (
    <SvgWrap className={className}>
...
export function QrIcon({ className = "h-7 w-7" }: IconProps) {
  return (
    <SvgWrap className={className}>
...
export function DatabaseIcon({ className = "h-7 w-7" }: IconProps) {
  return (
    <SvgWrap className={className}>
...
export function HealthIcon({ className = "h-7 w-7" }: IconProps) {
  return (
    <SvgWrap className={className}>
...
export function IdCardIcon({ className = "h-7 w-7" }: IconProps) {
  return (
    <SvgWrap className={className}>
...
export function GovernmentIcon({ className = "h-7 w-7" }: IconProps) {
  return (
    <SvgWrap className={className}>
...
export function PeopleIllustration({ className = "h-72 w-full" }: IconProps) {
  return (
